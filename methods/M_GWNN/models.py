...
class M_GWNN(keras.Model):
    def __init__(self, parameters, input_dim, output_dim, node_num, num_features_nonzero, data=None, **kwargs):
        ...
        for i, (layer_in, layer_out) in enumerate(layers_in_out_dims):
            ...
            self.layers_.append(Multi_Wavelet_Convolution(node_num=self.node_num,
                                           num_scales=parameters.num_wavelet_s,
                                           ...
                                           is_first_layer=sparse))

        self.layers_.append(Multi_scale_add_n(node_num=self.node_num,
                                           num_scales=parameters.num_wavelet_s,
                                           weight_normalize=self.weight_normalize,
